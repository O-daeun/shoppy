...
<table>
 <tr>
  <td>
   <h4>PC</h4>
      <img src="https://github.com/O-daeun/shoppy/assets/105799083/4d1163f8-790d-4d56-88ef-fb11b71ace26" width="600" />  
  </td>
  <td>
   <h4>Mobile</h4>
...
<table>
 <tr>
  <td>
   <img src="https://github.com/O-daeun/shoppy/assets/105799083/5a170004-6e37-4a91-b5bf-4278df5ffd28" width="320" />
  </td>
  <td>
   <h4>구글계정 로그인 팝업창</h4>
    <p>- Firebase의 Authentication 기능을 활용하여 <br />
    구글계정으로 로그인을 할 수 있도록 구현함</p>
  </td>
 </tr>
 <tr>
  <td>
   <img src="https://github.com/O-daeun/shoppy/assets/105799083/0b020b55-758a-4831-b45b-d831d5e8d9a6" width="320" />
  </td>
  <td>
   <h4>프로필</h4>
   <p>- 로그인 시 구글계정의 프로필사진과 이름이 상단에 보여짐</p>
  </td>
 </tr>
</table>
<br />
...
<p>
 - 로그인 여부 및 관리자 여부에 따라 접근제한이 있는 페이지 구현함<br />
 - url로 해당 페이지를 직접 입력하더라도 권한이 없다면 다시 홈으로 돌아가도록 구현함
</p>
<table>
 <tr>
  <td>
 ...
 <tr>
  ...
  <td>
   <p>관리자 계정에서 이미지 선택 및 제품 상세정보 작성 후 제출 시<br />
    이미지는 Cloudinary에, 제춤 전체 정보는 Firebase에 저장됨</p>
  </td>
 </tr>
</table>
<br />
